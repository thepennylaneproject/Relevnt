...
export const TIER_LIMITS = {
  starter: {
    allowedTasks: ['job-extraction', 'job-ranking', 'cover-letter-gen', 'qa-helper', 'resume-analysis'],
    monthlyLimit: 50,
    maxTokens: 1000,
  },
  pro: {
    allowedTasks: ['job-extraction', 'job-ranking', 'cover-letter-gen', 'ats-optimization', 'qa-helper', 'skill-gap-analysis', 'job-matching', 'interview-questions', 'resume-analysis'],
    monthlyLimit: 500,
    maxTokens: 4000,
  },
  premium: {
    allowedTasks: ['job-extraction', 'job-ranking', 'cover-letter-gen', 'ats-optimization', 'qa-helper', 'skill-gap-analysis', 'interview-questions', 'interview-scoring', 'job-matching', 'posting-finder', 'success-probability', 'resume-analysis'],
    monthlyLimit: 5000,
    maxTokens: 16000,
  },
};
