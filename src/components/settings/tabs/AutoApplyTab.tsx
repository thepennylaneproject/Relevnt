...
export function AutoApplyTab({ onAutoSaveStatusChange }: AutoApplyTabProps) {
    ...
    // We keep onAutoSaveStatusChange as 'idle' for now since useAutoApplySettings handles its own persistence
    // but in a real implementation we would sync this with the auto-save status.
    useEffect(() => {
