          ...
          >
            <div style={{ display: 'grid', gap: 16 }}>
              ...
              <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                <button
                  type="button"
                  onClick={() => showToast('Data export coming soon. Contact support@relevnt.ai for immediate exports.', 'info')}
                ...
                <button
                  ...
                  onClick={() => {
                    if (confirm('Are you sure you want to delete your account? This cannot be undone.')) {
                      showToast('Account deletion must be confirmed via email. Contact support@relevnt.ai.', 'warning')
                    }
                  }}
                  className="option-button"
